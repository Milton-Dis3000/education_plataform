                    ...
                    <div id="toggleBar">
                        ...
                        <div id="infeText">
                            ...
                            <div id="logout">
                                ...
                                <a href="/views_Alumno/alumno.php">Logout</a>
            ...
            <div class="pl-4 w-full h-auto flex flex-col md:flex-row">
                    ...
                    <div class="table-responsive">
                        <table id="tabla-materias-inscritas" class="table table-striped">
                            <div class="flex justify-between items-center">
                                <h2 class="text-lg font-semibold">Tus materias Inscritas</h2>
                            </div>
                            <thead>
                                <tr>
                                    <th class="py-2">#</th>
                ...
                <div class="w-full md:w-1/4 pl-4 mb-4 md:mb-0 rounded-md bg-white">
                    ...
                    <div class="bg-slate-600">
                        <?php
                        // Reiniciar la consulta para obtener las materias disponibles
